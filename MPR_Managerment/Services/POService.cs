    ...
    public class POService
    {
        ...
        private PODetail MapDetail(SqlDataReader r)
        {
            return new PODetail
            {
                ...
                Asize = r["Asize"] != DBNull.Value ? Convert.ToDecimal(r["Asize"]) : 0,
                Bsize = r["Bsize"] != DBNull.Value ? Convert.ToDecimal(r["Bsize"]) : 0,
                Csize = r["Csize"] != DBNull.Value ? Convert.ToDecimal(r["Csize"]) : 0,
