...
namespace MPR_Managerment.Helpers
{
    public static class DatabaseHelper
    {
        ...
        "Server=tcp:dlhi.database.windows.net,1433;Initial Catalog=MPR_Management;Persist Security Info=False;User ID=davidhoang;Password=Hoangquyen@1905;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
