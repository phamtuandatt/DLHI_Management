...
namespace MPR_Managerment.Forms
{
    public class frmNotificationLog : frmBase
    {
        ...
        private void LoadLogs()
        {
            try
            {
                var logs = _logService.GetLogs(txtUser.Text, dtpFrom.Value, dtpTo.Value);
                ...
                if (dgvLogs.Columns["Sent_At"] != null) dgvLogs.Columns["Sent_At"].HeaderText = "Thời gian";
                if (dgvLogs.Columns["Sent_By"] != null) dgvLogs.Columns["Sent_By"].HeaderText = "Người gửi";
                if (dgvLogs.Columns["Recipient"] != null) dgvLogs.Columns["Recipient"].HeaderText = "Người nhận/Nhóm";
                if (dgvLogs.Columns["Type"] != null) dgvLogs.Columns["Type"].HeaderText = "Loại";
                if (dgvLogs.Columns["Content"] != null) dgvLogs.Columns["Content"].HeaderText = "Nội dung";
                if (dgvLogs.Columns["Status"] != null) dgvLogs.Columns["Status"].HeaderText = "Trạng thái";
                if (dgvLogs.Columns["Error_Message"] != null) dgvLogs.Columns["Error_Message"].HeaderText = "Lỗi";
                if (dgvLogs.Columns["Project_Code"] != null) dgvLogs.Columns["Project_Code"].HeaderText = "Mã dự án";
            }
            catch (Exception ex)
            {
