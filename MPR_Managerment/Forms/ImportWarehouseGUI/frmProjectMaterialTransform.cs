    ...
    public partial class frmProjectMaterialTransform : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                wh.Notes = string.IsNullOrEmpty(txtNotes.Text.Trim()) ? txtNotes.Text.Trim() : $"Chuyển vật tư của dự án {wh.Project_Code} sang cho dự án {cboProject.SelectedItem.ToString()}";
                var rs = _warehouseServices.ProjectMaterialTransform(wh, wh.Project_Code, cboProject.SelectedItem.ToString() ?? wh.Project_Code, txtQty.Value);
